...
export class News extends Component {
    ...
    constructor() {
        super();
        console.log("i am a constructure from news component");
        this.state = {
            articles: [],
            loading: true,
            page: 1
    ...
    handleprevclick = async () => {
        ...
        console.log("cdm");
        let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apikey=${this.props.apikey}&page=${this.setstate.page = 1} &pagesize=${this.props.pagesize}`;
    ...
    render() {
        return (
            <div className='container my-3'>
                <h1 className="text-center">INews top-HeadLines</h1>
